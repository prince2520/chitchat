...
import { blockUserGroupThunk, createGroupMessageThunk, createGroupThunk, createPrivateMessageThunk, createPrivateThunk, deleteGroupThunk, deletePrivateThunk, joinGroupThunk, leaveGroupThunk, removeUserGroupThunk, unblockUserGroupThunk, updateGroupThunk } from "../thunks/chatThunk";
...
const ChatSlice = createSlice({
    ...
    reducers: {
        selectedChat(state, action) {
            const { isSelected, selectedId, selectedType } = action.payload;
            state = { ...state, isSelected, selectedId, selectedType };
        },
        addUserGroup(state, action) {
            const remove_id = action.payload.add_id;
            const groupId = action.payload.groupId;
        ...
        createMessage(state, action) {
            ...
            isGroup ? saveMessage(state.groups) : saveMessage(state.privates)
        },
        createPrivate,
        removeUserGroup,
        updateGroup,
